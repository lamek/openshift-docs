...
* There is an issue when installing the Metering Operator through Operator Hub. A fix is planned for a future patch of {product-title}, however a link:https://github.com/kube-reporting/metering-operator/blob/master/Documentation/manual-install.md[manual installation of the Metering Operator is still currently supported].
...
link:https://access.redhat.com/errata/RHBA-2020:1582[RHBA-2019:1582] advisory.
...
link:https://access.redhat.com/solutions/5026241[{product-title} 4.4.0 container image list]
...
[[RHSA-2020-1941]]
=== RHSA-2020:1941 - Moderate: {product-title} 4.4 Security Update

Issued: 2020-04-30

An update for logging-elasticsearch5-container is now available for
{product-title} 4.4. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:1941[RHSA-2020:1941] advisory.
